...
#ifndef ofxPostGlitchExample_CrHighContrast_h
#define ofxPostGlitchExample_CrHighContrast_h

#include "ofMain.h"
#include "PGShaderConstants.h"

class CrHighContrast : public ofShader
{
public:
    
    CrHighContrast() : ofShader()
    {
        string vertexShader;
