...
#ifndef ofxPostGlitchExample_CrGreeninvert_h
#define ofxPostGlitchExample_CrGreeninvert_h

#include "ofMain.h"
#include "PGShaderConstants.h"

class CrGreeninvert : public ofShader
{
public:
    
    CrGreeninvert() : ofShader()
    {
        string vertexShader;
